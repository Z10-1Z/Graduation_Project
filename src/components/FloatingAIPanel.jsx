...
export default function FloatingAIPanel({ role = 'patient' }) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 end-4 z-[9999] flex flex-row items-center gap-2 max-w-[calc(100vw-1rem)]">
        {!open && (
          <div className="pointer-events-none hidden sm:flex items-center gap-1.5 max-w-[min(12rem,calc(100vw-5rem))] truncate rounded-xl bg-white px-3 py-1.5 shadow-md">
